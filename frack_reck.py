...
window = gr.GrapWin("rus game", 800, 800)
alpha = 0.2
def fractal_rectange(A, B, C, D, deep=10):
	if deep < 1:
		return
	...
	fractal_rectange(A1, B1, C1, D1, deep-1)
	
fractal_rectange((100, 100), (500, 100), (500, 500), (100, 500))